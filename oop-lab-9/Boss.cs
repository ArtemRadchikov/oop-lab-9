...
namespace oop_lab_9
{
    ...
    static class Boss
    {
        ...
        public static void TurnOn(this Technique obj,int volt)
        {
            ...
            if(obj.AllowableVoltage < volt )
            {
                ...
                Console.WriteLine("Напряжение велико, запускаю процесс улучшения техники..");
            }
        ...
        public static void TurnOn(this SemiTechnique obj, int voltM,int voltT)
        {
            ...
            Upgrading += () =>
            {
                Console.WriteLine("Человек(выносливость): Увеличено на 10");
                return obj.AllowableVoltageMen += 10;
            };
    ...
    public class Technique
    {
        ...
        {
            Console.WriteLine("Увеличено на 50");
            return AllowableVoltage += 50;
        }
        ...
        {
            Console.WriteLine("Увеличено на 100");
            return AllowableVoltage += 100;
        }
    }
